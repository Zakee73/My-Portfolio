import { a, button, link } from 'framer-motion/client';
      ...
      <motion.nav
       ...
       >
        <div className='flex items-center justify-between w-full space-x-6 lg:space-x-8 '>
            ...
            >
              <span className={'font-bold  text-xl'}>Portfolio <span >.</span></span>
            </motion.a>
            {/* Navigation Items */}
            <div className='hidden text-white lg:flex items-center space-x-6'> 
               {navItems.map((items) =>(
                <a 
                href={items.link}
                key={items.name}
              ...
              >
                ...
                className={`py-3 px-4 rounded-lg text-center
                  ${activeSection ===  item.name.toLowerCase()
                    ? darkMode ?'bg-gray-800' : 'bg-orange-300'
                  : ''}`}
